        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              max={surah.ayahCount}
              value={fromAyah}
              onChange={(e) => setFromAyah(Math.max(1, Math.min(surah.ayahCount, Number(e.target.value))))}
          ...
          <div>
            ...
            <input
              ...
              max={surah.ayahCount}
              value={toAyah}
              onChange={(e) => setToAyah(Math.max(1, Math.min(surah.ayahCount, Number(e.target.value))))}
              className="w-full border border-zinc-200 rounded-lg px-3 py-2.5 text-sm bg-zinc-50 outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all text-zinc-900 font-medium"
            />
          </div>
        </div>
